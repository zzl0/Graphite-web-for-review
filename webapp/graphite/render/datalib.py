...
from graphite.render.hashing import ConsistentHashRing, Hash
...
class CarbonLinkPool:
  def __init__(self, hosts, timeout, relay_method):
    ...
    hash_cls = {'hashing': Hash, 'consistent-hashing': ConsistentHashRing}[relay_method]
    self.hash_ring = hash_cls(self.hosts)
    self.connections = {}
    self.last_failure = {}
  ...
  def query(self, metric):
    ...
    results = self.send_request(request)['datapoints']
